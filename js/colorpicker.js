...
//		if (inst._input[0].value != $.css(inst._sampleSpan,'background-color'))
    if (inst._input[0].value != inst._sampleSpan.css('background-color'))
		{
...
$.extend(ColorPickerInstance.prototype, {
	...
	_generateColorPicker: function() {
        ...
        var width = 18;
	    var html = "<table border='0' style='border:1px solid #000;' cellspacing='0' cellpadding='0'>";
		...
		html += '<tr><td title="" style="background-color:#fff" class="color" colspan="' + width + '" align="center"><label>Keine Farbe w&auml;hlen!</label></td></tr>'
...
$.fn.setSpanColor = function(value) {
	var inst = (this.length > 0 ? $.colorPicker._getInst(this[0]._colId) : null);
	if (inst) inst._sampleSpan.css("background-color",value)
};
